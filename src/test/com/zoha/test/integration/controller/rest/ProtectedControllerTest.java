package com.zoha.test.integration.controller.rest;

import com.zoha.EcareServer;
import com.zoha.model.json.request.AuthenticationRequest;
import com.zoha.model.json.response.AuthenticationResponse;
import com.zoha.test.integration.util.RequestEntityBuilder;
import com.zoha.test.integration.util.TestApiConfig;
...
@SpringApplicationConfiguration(classes = EcareServer.class)
@WebIntegrationTest
